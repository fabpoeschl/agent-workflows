...
- If this review is part of a task (a task directory exists), write the review to `doc/agents/tasks/<task-name>/review.md`. Otherwise, present directly in conversation.
